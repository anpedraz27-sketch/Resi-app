      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="md:col-span-2 bg-slate-900 border border-slate-800 p-6 rounded-xl">
            ...
            <div className="space-y-4">
                <input 
                    className="w-full bg-slate-950 border border-slate-800 rounded-lg p-3 text-white focus:ring-2 focus:ring-sky-500 outline-none"
                    placeholder="Title"
                    value={announcement.title}
                    onChange={e => setAnnouncement({...announcement, title: e.target.value})}
                />
                <textarea 
                    className="w-full bg-slate-950 border border-slate-800 rounded-lg p-3 text-white focus:ring-2 focus:ring-sky-500 outline-none h-24"
                ...
                <button 
                    ...
                    className="bg-sky-500 hover:bg-sky-600 text-white px-6 py-2 rounded-lg font-medium flex items-center gap-2 transition-all"
                >
      ...
      <div className="space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {amenities.map(am => {
            ...
            return (
              <div key={am.id} className="bg-slate-900 border border-slate-800 p-6 rounded-xl relative group">
                <button 
                ...
                <div className="w-12 h-12 rounded-full bg-slate-800 flex items-center justify-center text-sky-500 mb-4">
                  <Icon size={24} />
                </div>
                <h4 className="text-lg font-bold text-white">{am.name}</h4>
                <p className="text-slate-400 text-sm mt-1">{am.description || 'No description provided.'}</p>
